...
class AnimalTest {
  ...
  public static Animal creerAnimal(String nom, String type) {
    Animal thisAnimal;
    switch (type) {
      case "chien":
        thisAnimal = new Chien(nom);
        break;
      case "chat":
        thisAnimal = new Chat(nom);
        break;
      case "vache":
        thisAnimal = new Vache(nom);
        break;
      case "canard":
        thisAnimal = new Canard(nom);
        break;
      default:
